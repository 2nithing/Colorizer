...
def colorizer(img):
    ...
    prototxt = r"/workspaces/Colorizer/models/models_colorization_deploy_v2.prototxt"
    model = r"/workspaces/Colorizer/models/colorization_release_v2.caffemodel"
    points = r"/workspaces/Colorizer/models/pts_in_hull.npy"
